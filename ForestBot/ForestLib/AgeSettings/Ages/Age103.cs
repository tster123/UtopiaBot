...
public class Age103Settings : IAgeSettings
{
    ...
    public Race Elf = new("Elf") { TrainingTime = 0.75 };
    ...
    private BuildingEffectsAge103 buildingEffects;
    private ScienceEffectsAge103 scienceEffects;
    public Age103Settings()
    {
        ...
        buildingEffects = new BuildingEffectsAge103();
        scienceEffects = new ScienceEffectsAge103();
    }
...
public class BuildingEffectsAge103 : IBuildingEffects
{
...
public class ScienceEffectsAge103 : IScienceEffects
{
