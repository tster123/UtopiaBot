...
from Operations
where Timestamp > '2023-12-17 03:35' and TargetKingdom = '6:12'
group by OpName
order by OpName
...
from Operations
where Timestamp > '2023-12-17 03:35' and TargetKingdom is null and TargetProvince is not null
...
from Attacks
where TargetKingdom = '6:12' and AttackType = 'mass' and Timestamp > '2023-12-17 03:35'
union all
select SourceProvince, TargetProvince, Kills + Prisoners 
from Attacks 
where TargetKingdom = '6:12' and Timestamp > '2023-12-17 03:35'
union all
select SourceProvince, TargetProvince, Damage
from Operations
where TargetKingdom = '6:12' and Success = 1 and OpName in ('fireball', 'night strike', 'assassinate wizards') and Timestamp > '2023-12-17 03:35'
) v
